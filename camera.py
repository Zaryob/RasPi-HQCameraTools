...
for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
        ...
        rotated = imutils.rotate(frame.array, -90)
        image = cv2.rectangle(rotated,(capture_button[2], capture_button[0]),(capture_button[3],capture_button[1]),(0,255,0),-1)
        image = cv2.rectangle(rotated,(close_button[2], close_button[0]),(close_button[3],close_button[1]),(0,0,255),-1)
